        ...
        <header className="shadow-lg animate__animated animate__fadeInDown">
            <div className="container flex justify-between m-auto rounded">
                ...
                <div className="flex items-center gap-4">
                    <Link to='/carrito' className="relative animate__animated animate__pulse animate__delay-1s animate__slow">
                    ...
                    <div className="md:hidden px-3">
                        ...
                        <div className={`fixed z-10 top-0 right-0 h-[550px] bg-white transition-transform transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden w-64 p-4`}>
