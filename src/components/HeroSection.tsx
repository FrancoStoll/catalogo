        ...
        <section className="container mx-auto">
            <div className="md:flex md:h-[calc(100vh-4rem)]">
                <div className="md:w-1/2 flex flex-col justify-center p-5 items-start gap-3">
                    ...
                    <p className="text-gray-500 text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates suscipit ab inventore cum maxime consequatur,cumque dignissimos, ratione unde eos.</p>
